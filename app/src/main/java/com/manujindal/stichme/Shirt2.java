...
public class Shirt2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("OrderId in Shirt2: ", Long.toString(OrderId));
        Log.i("CustomerId in Shirt2: ", Long.toString(CustomerId));
        Log.i("ShirtId in Shirt2: ", Long.toString(ShirtId));
        Log.i("Source in Shirt2: ", source);
    ...
    public void nextActFromMain(View view) {
        ...
        Intent intent = new Intent(this, Shirt3.class);

        String Shirt_PocketType;
        Shirt_PocketType = view.getTag().toString();

        try {

            String sql = "UPDATE shirts SET Shirt_PocketType = '"+Shirt_PocketType+"' WHERE ShirtId = "+ShirtId;
            ...
            while(c!=null)
            {
                Log.i("Result ShirtPcktType: ", c.getString(c.getColumnIndex("Shirt_PocketType")));
                c.moveToNext();
            }
