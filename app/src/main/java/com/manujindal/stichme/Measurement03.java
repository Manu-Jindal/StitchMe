...
public class Measurement03 extends AppCompatActivity {
    Intent intent;
    long OrderId;
    long CustomerId;
    String source;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement03);
        ...
        Log.i("OrderId in Msrmnt3: ", Long.toString(OrderId));
        Log.i("CustomerId in Msrmnt3:", Long.toString(CustomerId));
        Log.i("MsrmtsId in Msrmnt3: ", Long.toString(MeasurementsId));
        Log.i("Source in Msrmnt3: ", source);
    ...
    public void nextActivity(View view) {
        ...
        Intent intent = new Intent(this, Measurement04.class);
        ...
        try {
            String sql = "UPDATE measurements SET Measurement3 = '"+measurement0+"' WHERE MeasurementsId = "+MeasurementsId;
