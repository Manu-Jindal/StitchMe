...
public class Measurement28 extends AppCompatActivity {
    Intent intent;
    long OrderId;
    long CustomerId;
    String source;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement28);
        ...
        Log.i("OrderId in Msrmnt28: ", Long.toString(OrderId));
        Log.i("CustomerId in Msrmnt28:", Long.toString(CustomerId));
        Log.i("MsrmtsId in Msrmnt28: ", Long.toString(MeasurementsId));
        Log.i("Source in Msrmnt28: ", source);
    ...
    public void nextActivity(View view) {
        ...
        Intent intent = new Intent(this, Measurement29.class);
        ...
        try {
            String sql = "UPDATE measurements SET Measurement28 = '"+measurement0+"' WHERE MeasurementsId = "+MeasurementsId;
