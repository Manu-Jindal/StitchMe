...
public class Measurement06 extends AppCompatActivity {
    Intent intent;
    long OrderId;
    long CustomerId;
    String source;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement06);
        ...
        Log.i("OrderId in Msrmnt6: ", Long.toString(OrderId));
        Log.i("CustomerId in Msrmnt6:", Long.toString(CustomerId));
        Log.i("MsrmtsId in Msrmnt6: ", Long.toString(MeasurementsId));
        Log.i("Source in Msrmnt6: ", source);
    ...
    public void nextActivity(View view) {
        ...
        Intent intent = new Intent(this, Measurement07.class);
        ...
        try {
            String sql = "UPDATE measurements SET Measurement6 = '"+measurement0+"' WHERE MeasurementsId = "+MeasurementsId;
