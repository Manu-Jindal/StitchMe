...
public class Measurement29 extends AppCompatActivity {
    Intent intent;
    long OrderId;
    long CustomerId;
    String source;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement29);
        ...
        Log.i("OrderId in Msrmnt29: ", Long.toString(OrderId));
        Log.i("CustomerId in Msrmnt29:", Long.toString(CustomerId));
        Log.i("MsrmtsId in Msrmnt29: ", Long.toString(MeasurementsId));
        Log.i("Source in Msrmnt29: ", source);
    ...
    public void nextActivity(View view) {
        ...
        Intent intent = new Intent(this, Measurement30.class);
        ...
        try {
            String sql = "UPDATE measurements SET Measurement29 = '"+measurement0+"' WHERE MeasurementsId = "+MeasurementsId;
