...
public class Measurement15 extends AppCompatActivity {
    Intent intent;
    long OrderId;
    long CustomerId;
    String source;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement15);
        ...
        Log.i("OrderId in Msrmnt15: ", Long.toString(OrderId));
        Log.i("CustomerId in Msrmnt15:", Long.toString(CustomerId));
        Log.i("MsrmtsId in Msrmnt15: ", Long.toString(MeasurementsId));
        Log.i("Source in Msrmnt15: ", source);
    ...
    public void nextActivity(View view) {
        ...
        Intent intent = new Intent(this, Measurement16.class);
        ...
        try {
            String sql = "UPDATE measurements SET Measurement15 = '"+measurement0+"' WHERE MeasurementsId = "+MeasurementsId;
