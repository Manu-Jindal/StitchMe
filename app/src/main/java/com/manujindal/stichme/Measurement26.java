...
public class Measurement26 extends AppCompatActivity {
    Intent intent;
    long OrderId;
    long CustomerId;
    String source;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement26);
        ...
        Log.i("OrderId in Msrmnt26: ", Long.toString(OrderId));
        Log.i("CustomerId in Msrmnt26:", Long.toString(CustomerId));
        Log.i("MsrmtsId in Msrmnt26: ", Long.toString(MeasurementsId));
        Log.i("Source in Msrmnt26: ", source);
    ...
    public void nextActivity(View view) {
        ...
        Intent intent = new Intent(this, Measurement27.class);
        ...
        try {
            String sql = "UPDATE measurements SET Measurement26 = '"+measurement0+"' WHERE MeasurementsId = "+MeasurementsId;
