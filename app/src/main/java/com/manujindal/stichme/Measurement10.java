...
public class Measurement10 extends AppCompatActivity {
    Intent intent;
    long OrderId;
    long CustomerId;
    String source;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement10);
        ...
        Log.i("OrderId in Msrmnt10: ", Long.toString(OrderId));
        Log.i("CustomerId in Msrmnt10:", Long.toString(CustomerId));
        Log.i("MsrmtsId in Msrmnt10: ", Long.toString(MeasurementsId));
        Log.i("Source in Msrmnt10: ", source);
    ...
    public void nextActivity(View view) {
        ...
        Intent intent = new Intent(this, Measurement11.class);
        ...
        try {
            String sql = "UPDATE measurements SET Measurement10 = '"+measurement0+"' WHERE MeasurementsId = "+MeasurementsId;
