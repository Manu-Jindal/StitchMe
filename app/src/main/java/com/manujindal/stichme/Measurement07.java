...
public class Measurement07 extends AppCompatActivity {
    Intent intent;
    long OrderId;
    long CustomerId;
    String source;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement07);
        ...
        Log.i("OrderId in Msrmnt7: ", Long.toString(OrderId));
        Log.i("CustomerId in Msrmnt7:", Long.toString(CustomerId));
        Log.i("MsrmtsId in Msrmnt7: ", Long.toString(MeasurementsId));
        Log.i("Source in Msrmnt7: ", source);
    ...
    public void nextActivity(View view) {
        ...
        Intent intent = new Intent(this, Measurement08.class);
        ...
        try {
            String sql = "UPDATE measurements SET Measurement7 = '"+measurement0+"' WHERE MeasurementsId = "+MeasurementsId;
