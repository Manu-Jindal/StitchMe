...
public class Measurement11 extends AppCompatActivity {
    Intent intent;
    long OrderId;
    long CustomerId;
    String source;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement11);
        ...
        Log.i("OrderId in Msrmnt11: ", Long.toString(OrderId));
        Log.i("CustomerId in Msrmnt11:", Long.toString(CustomerId));
        Log.i("MsrmtsId in Msrmnt11: ", Long.toString(MeasurementsId));
        Log.i("Source in Msrmnt11: ", source);
    ...
    public void nextActivity(View view) {
        ...
        Intent intent = new Intent(this, Measurement12.class);
        ...
        try {
            String sql = "UPDATE measurements SET Measurement11 = '"+measurement0+"' WHERE MeasurementsId = "+MeasurementsId;
