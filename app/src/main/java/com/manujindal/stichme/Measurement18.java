...
public class Measurement18 extends AppCompatActivity {
    Intent intent;
    long OrderId;
    long CustomerId;
    String source;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement18);
        ...
        Log.i("OrderId in Msrmnt18: ", Long.toString(OrderId));
        Log.i("CustomerId in Msrmnt18:", Long.toString(CustomerId));
        Log.i("MsrmtsId in Msrmnt18: ", Long.toString(MeasurementsId));
        Log.i("Source in Msrmnt18: ", source);
    ...
    public void nextActivity(View view) {
        ...
        Intent intent = new Intent(this, Measurement19.class);
        ...
        try {
            String sql = "UPDATE measurements SET Measurement18 = '"+measurement0+"' WHERE MeasurementsId = "+MeasurementsId;
