...
public class GetMeasured4 extends AppCompatActivity {
    Intent intent;
    int id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_measured4);
        intent = getIntent();
        id = intent.getIntExtra("id1", -1);
        Log.i("ID in GetMsrd4 result: ", Integer.toString(id));
    ...
    public void nextActivity(View view) {
        ...
        Intent intent = new Intent(this, GetMeasured5.class);
        ...
        try {
            String sql = "UPDATE abcd11 SET Measurement16 = '"+measurement0+"' WHERE id = "+id;
            database.execSQL(sql);
            String sql1 = "UPDATE abcd11 SET Measurement17 = '"+measurement1+"' WHERE id = "+id;
            database.execSQL(sql1);
            String sql2 = "UPDATE abcd11 SET Measurement18 = '"+measurement2+"' WHERE id = "+id;
            database.execSQL(sql2);
            String sql3 = "UPDATE abcd11 SET Measurement19 = '"+measurement3+"' WHERE id = "+id;
            database.execSQL(sql3);
            String sql4 = "UPDATE abcd11 SET Measurement20 = '"+measurement4+"' WHERE id = "+id;
            database.execSQL(sql4);

            Log.i("ID inGetMsrd4 result1: ", Integer.toString(id));
            ...
            while(c!=null)
            {
                ...
                Log.i("Result Measurement16: ", c.getString(c.getColumnIndex("Measurement16")));
                Log.i("Result Measurement17: ", c.getString(c.getColumnIndex("Measurement17")));
                Log.i("Result Measurement18: ", c.getString(c.getColumnIndex("Measurement18")));
                Log.i("Result Measurement19: ", c.getString(c.getColumnIndex("Measurement19")));
                Log.i("Result Measurement20: ", c.getString(c.getColumnIndex("Measurement20")));
                c.moveToNext();
            }
        }
        catch(Exception e)
