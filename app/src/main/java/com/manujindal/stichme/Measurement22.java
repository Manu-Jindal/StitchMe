...
public class Measurement22 extends AppCompatActivity {
    Intent intent;
    long OrderId;
    long CustomerId;
    String source;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement22);
        ...
        Log.i("OrderId in Msrmnt22: ", Long.toString(OrderId));
        Log.i("CustomerId in Msrmnt22:", Long.toString(CustomerId));
        Log.i("MsrmtsId in Msrmnt22: ", Long.toString(MeasurementsId));
        Log.i("Source in Msrmnt22: ", source);
    ...
    public void nextActivity(View view) {
        ...
        Intent intent = new Intent(this, Measurement23.class);
        ...
        try {
            String sql = "UPDATE measurements SET Measurement22 = '"+measurement0+"' WHERE MeasurementsId = "+MeasurementsId;
