...
public class Measurement04 extends AppCompatActivity {
    Intent intent;
    long OrderId;
    long CustomerId;
    String source;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement04);
        ...
        Log.i("OrderId in Msrmnt4: ", Long.toString(OrderId));
        Log.i("CustomerId in Msrmnt4:", Long.toString(CustomerId));
        Log.i("MsrmtsId in Msrmnt4: ", Long.toString(MeasurementsId));
        Log.i("Source in Msrmnt4: ", source);
    ...
    public void nextActivity(View view) {
        ...
        Intent intent = new Intent(this, Measurement05.class);
        ...
        try {
            String sql = "UPDATE measurements SET Measurement4 = '"+measurement0+"' WHERE MeasurementsId = "+MeasurementsId;
