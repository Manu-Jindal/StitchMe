...
public class Measurement01 extends AppCompatActivity {
    Intent intent;
    long OrderId;
    long CustomerId;
    String source;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement01);
        ...
        Log.i("OrderId in Msrmnt1: ", Long.toString(OrderId));
        Log.i("CustomerId in Msrmnt1:", Long.toString(CustomerId));
        Log.i("MsrmtsId in Msrmnt1: ", Long.toString(MeasurementsId));
        Log.i("Source in Msrmnt1: ", source);
    ...
    public void nextActivity(View view) {
        ...
        Intent intent = new Intent(this, Measurement02.class);
        ...
        try {
            String sql = "UPDATE measurements SET Measurement1 = '"+measurement0+"' WHERE MeasurementsId = "+MeasurementsId;
