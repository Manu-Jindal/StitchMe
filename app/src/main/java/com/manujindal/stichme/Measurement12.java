...
public class Measurement12 extends AppCompatActivity {
    Intent intent;
    long OrderId;
    long CustomerId;
    String source;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement12);
        ...
        Log.i("OrderId in Msrmnt12: ", Long.toString(OrderId));
        Log.i("CustomerId in Msrmnt12:", Long.toString(CustomerId));
        Log.i("MsrmtsId in Msrmnt12: ", Long.toString(MeasurementsId));
        Log.i("Source in Msrmnt12: ", source);
    ...
    public void nextActivity(View view) {
        ...
        Intent intent = new Intent(this, Measurement13.class);
        ...
        try {
            String sql = "UPDATE measurements SET Measurement12 = '"+measurement0+"' WHERE MeasurementsId = "+MeasurementsId;
