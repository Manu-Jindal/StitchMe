...
public class Measurement05 extends AppCompatActivity {
    Intent intent;
    long OrderId;
    long CustomerId;
    String source;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement05);
        ...
        Log.i("OrderId in Msrmnt5: ", Long.toString(OrderId));
        Log.i("CustomerId in Msrmnt5:", Long.toString(CustomerId));
        Log.i("MsrmtsId in Msrmnt5: ", Long.toString(MeasurementsId));
        Log.i("Source in Msrmnt5: ", source);
    ...
    public void nextActivity(View view) {
        ...
        Intent intent = new Intent(this, Measurement06.class);
        ...
        try {
            String sql = "UPDATE measurements SET Measurement5 = '"+measurement0+"' WHERE MeasurementsId = "+MeasurementsId;
