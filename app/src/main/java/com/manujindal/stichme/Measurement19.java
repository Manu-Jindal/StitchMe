...
public class Measurement19 extends AppCompatActivity {
    Intent intent;
    long OrderId;
    long CustomerId;
    String source;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement19);
        ...
        Log.i("OrderId in Msrmnt19: ", Long.toString(OrderId));
        Log.i("CustomerId in Msrmnt19:", Long.toString(CustomerId));
        Log.i("MsrmtsId in Msrmnt19: ", Long.toString(MeasurementsId));
        Log.i("Source in Msrmnt19: ", source);
    ...
    public void nextActivity(View view) {
        ...
        Intent intent = new Intent(this, Measurement20.class);
        ...
        try {
            String sql = "UPDATE measurements SET Measurement19 = '"+measurement0+"' WHERE MeasurementsId = "+MeasurementsId;
