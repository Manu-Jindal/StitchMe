...
public class Measurement21 extends AppCompatActivity {
    Intent intent;
    long OrderId;
    long CustomerId;
    String source;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement21);
        ...
        Log.i("OrderId in Msrmnt21: ", Long.toString(OrderId));
        Log.i("CustomerId in Msrmnt21:", Long.toString(CustomerId));
        Log.i("MsrmtsId in Msrmnt21: ", Long.toString(MeasurementsId));
        Log.i("Source in Msrmnt21: ", source);
    ...
    public void nextActivity(View view) {
        ...
        Intent intent = new Intent(this, Measurement22.class);
        ...
        try {
            String sql = "UPDATE measurements SET Measurement21 = '"+measurement0+"' WHERE MeasurementsId = "+MeasurementsId;
