...
public class Shirt3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("OrderId in Shirt3: ", Long.toString(OrderId));
        Log.i("CustomerId in Shirt3: ", Long.toString(CustomerId));
        Log.i("ShirtId in Shirt3: ", Long.toString(ShirtId));
        Log.i("Source in Shirt3: ", source);
    ...
    public void nextActFromMain(View view) {
        ...
        Intent intent = new Intent(this, Shirt4.class);

        String Shirt_CuffType;
        Shirt_CuffType = view.getTag().toString();

        try {

            String sql = "UPDATE shirts SET Shirt_CuffType = '"+Shirt_CuffType+"' WHERE ShirtId = "+ShirtId;
            ...
            while(c!=null)
            {
                Log.i("Result ShirtCuffType: ", c.getString(c.getColumnIndex("Shirt_CuffType")));
                c.moveToNext();
            }
