...
public class Measurement08 extends AppCompatActivity {
    Intent intent;
    long OrderId;
    long CustomerId;
    String source;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement08);
        ...
        Log.i("OrderId in Msrmnt8: ", Long.toString(OrderId));
        Log.i("CustomerId in Msrmnt8:", Long.toString(CustomerId));
        Log.i("MsrmtsId in Msrmnt8: ", Long.toString(MeasurementsId));
        Log.i("Source in Msrmnt8: ", source);
    ...
    public void nextActivity(View view) {
        ...
        Intent intent = new Intent(this, Measurement09.class);
        ...
        try {
            String sql = "UPDATE measurements SET Measurement8 = '"+measurement0+"' WHERE MeasurementsId = "+MeasurementsId;
