...
public class Measurement09 extends AppCompatActivity {
    Intent intent;
    long OrderId;
    long CustomerId;
    String source;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement09);
        ...
        Log.i("OrderId in Msrmnt9: ", Long.toString(OrderId));
        Log.i("CustomerId in Msrmnt9:", Long.toString(CustomerId));
        Log.i("MsrmtsId in Msrmnt9: ", Long.toString(MeasurementsId));
        Log.i("Source in Msrmnt9: ", source);
    ...
    public void nextActivity(View view) {
        ...
        Intent intent = new Intent(this, Measurement10.class);
        ...
        try {
            String sql = "UPDATE measurements SET Measurement9 = '"+measurement0+"' WHERE MeasurementsId = "+MeasurementsId;
