...
public class ListViewAdapterWhite extends BaseAdapter
{
    Activity context;
    ArrayList<String> title = new ArrayList<>();
    ArrayList<String> description = new ArrayList<>();

    public ListViewAdapterWhite(Activity context, ArrayList<String> title, ArrayList<String> description) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null)
        {
            convertView = inflater.inflate(R.layout.item_details_grid_white, null);
