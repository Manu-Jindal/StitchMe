...
public class Measurement13 extends AppCompatActivity {
    Intent intent;
    long OrderId;
    long CustomerId;
    String source;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement13);
        ...
        Log.i("OrderId in Msrmnt13: ", Long.toString(OrderId));
        Log.i("CustomerId in Msrmnt13:", Long.toString(CustomerId));
        Log.i("MsrmtsId in Msrmnt13: ", Long.toString(MeasurementsId));
        Log.i("Source in Msrmnt13: ", source);
    ...
    public void nextActivity(View view) {
        ...
        Intent intent = new Intent(this, Measurement14.class);
        ...
        try {
            String sql = "UPDATE measurements SET Measurement13 = '"+measurement0+"' WHERE MeasurementsId = "+MeasurementsId;
