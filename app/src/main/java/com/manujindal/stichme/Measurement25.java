...
public class Measurement25 extends AppCompatActivity {
    Intent intent;
    long OrderId;
    long CustomerId;
    String source;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement25);
        ...
        Log.i("OrderId in Msrmnt25: ", Long.toString(OrderId));
        Log.i("CustomerId in Msrmnt25:", Long.toString(CustomerId));
        Log.i("MsrmtsId in Msrmnt25: ", Long.toString(MeasurementsId));
        Log.i("Source in Msrmnt25: ", source);
    ...
    public void nextActivity(View view) {
        ...
        Intent intent = new Intent(this, Measurement26.class);
        ...
        try {
            String sql = "UPDATE measurements SET Measurement25 = '"+measurement0+"' WHERE MeasurementsId = "+MeasurementsId;
