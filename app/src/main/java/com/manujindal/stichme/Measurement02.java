...
public class Measurement02 extends AppCompatActivity {
    Intent intent;
    long OrderId;
    long CustomerId;
    String source;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement02);
        ...
        Log.i("OrderId in Msrmnt2: ", Long.toString(OrderId));
        Log.i("CustomerId in Msrmnt2:", Long.toString(CustomerId));
        Log.i("MsrmtsId in Msrmnt2: ", Long.toString(MeasurementsId));
        Log.i("Source in Msrmnt2: ", source);
    ...
    public void nextActivity(View view) {
        ...
        Intent intent = new Intent(this, Measurement03.class);
        ...
        try {
            String sql = "UPDATE measurements SET Measurement2 = '"+measurement0+"' WHERE MeasurementsId = "+MeasurementsId;
