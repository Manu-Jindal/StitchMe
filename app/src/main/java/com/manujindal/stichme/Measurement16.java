...
public class Measurement16 extends AppCompatActivity {
    Intent intent;
    long OrderId;
    long CustomerId;
    String source;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement16);
        ...
        Log.i("OrderId in Msrmnt16: ", Long.toString(OrderId));
        Log.i("CustomerId in Msrmnt16:", Long.toString(CustomerId));
        Log.i("MsrmtsId in Msrmnt16: ", Long.toString(MeasurementsId));
        Log.i("Source in Msrmnt16: ", source);
    ...
    public void nextActivity(View view) {
        ...
        Intent intent = new Intent(this, Measurement17.class);
        ...
        try {
            String sql = "UPDATE measurements SET Measurement16 = '"+measurement0+"' WHERE MeasurementsId = "+MeasurementsId;
