...
public class Measurement30 extends AppCompatActivity {
    Intent intent;
    long OrderId;
    long CustomerId;
    String source;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement30);
        ...
        Log.i("OrderId in Msrmnt30: ", Long.toString(OrderId));
        Log.i("CustomerId in Msrmnt30:", Long.toString(CustomerId));
        Log.i("MsrmtsId in Msrmnt30: ", Long.toString(MeasurementsId));
        Log.i("Source in Msrmnt30: ", source);
    ...
    public void nextActivity(View view) {
        ...
        Intent intent = new Intent(this, Measurement31.class);
        ...
        try {
            String sql = "UPDATE measurements SET Measurement30 = '"+measurement0+"' WHERE MeasurementsId = "+MeasurementsId;
