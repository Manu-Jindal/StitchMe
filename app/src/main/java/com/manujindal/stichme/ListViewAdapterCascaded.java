...
public class ListViewAdapterCascaded extends BaseAdapter
{
    Activity context;
    ArrayList<String> title = new ArrayList<>();
    ArrayList<String> description = new ArrayList<>();

    public ListViewAdapterCascaded(Activity context, ArrayList<String> title, ArrayList<String> description) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null)
        {
            convertView = inflater.inflate(R.layout.item_details_cascaded, null);
