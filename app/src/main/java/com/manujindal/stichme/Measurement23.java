...
public class Measurement23 extends AppCompatActivity {
    Intent intent;
    long OrderId;
    long CustomerId;
    String source;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement23);
        ...
        Log.i("OrderId in Msrmnt23: ", Long.toString(OrderId));
        Log.i("CustomerId in Msrmnt23:", Long.toString(CustomerId));
        Log.i("MsrmtsId in Msrmnt23: ", Long.toString(MeasurementsId));
        Log.i("Source in Msrmnt23: ", source);
    ...
    public void nextActivity(View view) {
        ...
        Intent intent = new Intent(this, Measurement24.class);
        ...
        try {
            String sql = "UPDATE measurements SET Measurement23 = '"+measurement0+"' WHERE MeasurementsId = "+MeasurementsId;
