...
public class Measurement31 extends AppCompatActivity {
    Intent intent;
    long OrderId;
    long CustomerId;
    String source;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement31);
        ...
        Log.i("OrderId in Msrmnt31: ", Long.toString(OrderId));
        Log.i("CustomerId in Msrmnt31:", Long.toString(CustomerId));
        Log.i("MsrmtsId in Msrmnt31: ", Long.toString(MeasurementsId));
        Log.i("Source in Msrmnt31: ", source);
    ...
    public void nextActivity(View view) {
        ...
        try {
            String sql = "UPDATE measurements SET Measurement31 = '"+measurement0+"' WHERE MeasurementsId = "+MeasurementsId;
