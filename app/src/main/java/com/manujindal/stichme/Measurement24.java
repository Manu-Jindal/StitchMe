...
public class Measurement24 extends AppCompatActivity {
    Intent intent;
    long OrderId;
    long CustomerId;
    String source;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement24);
        ...
        Log.i("OrderId in Msrmnt24: ", Long.toString(OrderId));
        Log.i("CustomerId in Msrmnt24:", Long.toString(CustomerId));
        Log.i("MsrmtsId in Msrmnt24: ", Long.toString(MeasurementsId));
        Log.i("Source in Msrmnt24: ", source);
    ...
    public void nextActivity(View view) {
        ...
        Intent intent = new Intent(this, Measurement25.class);
        ...
        try {
            String sql = "UPDATE measurements SET Measurement24 = '"+measurement0+"' WHERE MeasurementsId = "+MeasurementsId;
