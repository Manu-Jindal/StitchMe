...
public class Measurement20 extends AppCompatActivity {
    Intent intent;
    long OrderId;
    long CustomerId;
    String source;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement20);
        ...
        Log.i("OrderId in Msrmnt20: ", Long.toString(OrderId));
        Log.i("CustomerId in Msrmnt20:", Long.toString(CustomerId));
        Log.i("MsrmtsId in Msrmnt20: ", Long.toString(MeasurementsId));
        Log.i("Source in Msrmnt20: ", source);
    ...
    public void nextActivity(View view) {
        ...
        try {
            String sql = "UPDATE measurements SET Measurement20 = '"+measurement0+"' WHERE MeasurementsId = "+MeasurementsId;
