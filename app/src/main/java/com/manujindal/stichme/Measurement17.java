...
public class Measurement17 extends AppCompatActivity {
    Intent intent;
    long OrderId;
    long CustomerId;
    String source;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measurement17);
        ...
        Log.i("OrderId in Msrmnt17: ", Long.toString(OrderId));
        Log.i("CustomerId in Msrmnt17:", Long.toString(CustomerId));
        Log.i("MsrmtsId in Msrmnt17: ", Long.toString(MeasurementsId));
        Log.i("Source in Msrmnt17: ", source);
    ...
    public void nextActivity(View view) {
        ...
        Intent intent = new Intent(this, Measurement18.class);
        ...
        try {
            String sql = "UPDATE measurements SET Measurement17 = '"+measurement0+"' WHERE MeasurementsId = "+MeasurementsId;
