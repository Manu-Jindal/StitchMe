...
public class GetMeasured1 extends AppCompatActivity {
    Intent intent;
    int id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_measured1);
        intent = getIntent();
        id = intent.getIntExtra("id1", -1);
        Log.i("ID in GetMsrd1 result: ", Integer.toString(id));
    ...
    public void nextActivity(View view) {
        ...
        Intent intent = new Intent(this, GetMeasured2.class);
        ...
        try {
            String sql = "UPDATE abcd11 SET Measurement3 = '"+measurement0+"' WHERE id = "+id;
            database.execSQL(sql);
            String sql1 = "UPDATE abcd11 SET Measurement4 = '"+measurement1+"' WHERE id = "+id;
            database.execSQL(sql1);
            String sql2 = "UPDATE abcd11 SET Measurement5 = '"+measurement2+"' WHERE id = "+id;
            database.execSQL(sql2);
            String sql3 = "UPDATE abcd11 SET Measurement6 = '"+measurement3+"' WHERE id = "+id;
            database.execSQL(sql3);

            Log.i("ID inGetMsrd1 result1: ", Integer.toString(id));
            ...
            while(c!=null)
            {
                ...
                Log.i("Result Measurement3: ", c.getString(c.getColumnIndex("Measurement3")));
                Log.i("Result Measurement4: ", c.getString(c.getColumnIndex("Measurement4")));
                Log.i("Result Measurement5: ", c.getString(c.getColumnIndex("Measurement5")));
                Log.i("Result Measurement6: ", c.getString(c.getColumnIndex("Measurement6")));
